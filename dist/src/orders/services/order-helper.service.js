...
let OrderHelperService = class OrderHelperService {
    ...
    calculateOrderTotals(subTotal, discount) {
        ...
        const totalAmount = Number((subTotal - discount + shippingCharge + estimatedTax).toFixed(2));
        return { shippingCharge, estimatedTax, totalAmount };
    }
    async saveOrder(dto, userId, subTotal, discount, shippingCharge, estimatedTax, totalAmount, couponCode) {
