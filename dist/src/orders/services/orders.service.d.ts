...
export declare class OrdersService {
    ...
    constructor(ordersRepository: Repository<Order>, orderItemsRepository: Repository<OrderItem>, paymentRepository: Repository<PaymentDetails>, trackingRepository: Repository<Tracking>, usersService: UsersService, couponService: CouponService, authService: AuthService, payPalService: PayPalService, orderHelperService: OrderHelperService);
